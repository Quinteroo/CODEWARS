...
// and you know it takes you one minute to traverse one city block, so create a function that will return true if the walk the 
// app gives you will take you exactly ten minutes (you don't want to be early or late!) and will, of course, return you to 
...
function isValidWalk(walk) {
  ...
  return (direcciones['n'] === direcciones['s']) && (direcciones['e'] === direcciones['w']);
}