...
Array.prototype.square = function () {
  return this.length === 0 ? NaN : this.map((e) => e * e)
};

Array.prototype.cube = function () {
  return this.length === 0 ? NaN : this.map((e) => e * e * e)
};

Array.prototype.sum = function () {
  return this.length === 0 ? NaN : this.reduce((a, b) => a + b, 0)
};
...
Array.prototype.even = function () {
  return this.length === 0 ? NaN : this.filter((e) => e % 2 === 0)
};
