...
// A Narcissistic Number (or Armstrong Number) is a positive number which is the sum of its own digits, each raised to the power of 
...
function narcissistic(value) {
  ...
  let b = value.toString().split("").map(Number)

  let c = b.map((e) => Math.pow(e, n))
...
//! Un número narcisista es aquel en el que la suma de sus dígitos elevados a la potencia del número de dígitos es exactamente igual al número original.