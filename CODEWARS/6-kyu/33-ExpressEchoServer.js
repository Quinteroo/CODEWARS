//! https://www.codewars.com/kata/62bf6fa7eccf8e000f9cae60/train/javascript
...
// An example query string is ?message=hello which would be echoed as {"message": "hello"}. 
// An empty string, ?message=, is valid and should be echoed normally.
...
//* POST /
// This route will parse the request body as JSON and echo a response containing the value 
// from the "message" key of the request. The JSON response is in the same format as the GET above: {"message": "some message"}. 
...
//* Notes
// Please use the variable name app to implement your server. Don't use app.listen() to start 
// the Express server; the test suite will invoke the route handlers directly on the app object.
...
// If you're not familiar with the Express concepts needed to complete this kata, feel free to 
// reference the documentation and other resources as you build your solution.
